    ...
    <div class="container">
        ...
        <div class="summary">
            ...
            <div class="summary-card">
                ...
                <div class="value">{result.total_dirs:,}</div>
            </div>
            <div class="summary-card">
                <div class="label">扫描耗时</div>
                <div class="value">{result.scan_duration:.2f}秒</div>
            </div>
        </div>
...
"""
    ...
    for i, d in enumerate(result.top_dirs[:20], 1):
        html += f"""                <tr>
                    <td>{i}</td>
                    <td>{d.name}</td>
...
"""
    ...
    html += f"""            </tbody>
        ...
        <div class="footer">
            <p>由 GoodClean v1.0 生成 | {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}</p>
        </div>
    </div>
</body>
</html>"""
